...
STYLE_PRESETS: Dict[str, Style] = {
    ...
    # ===== ФЭНТЕЗИ / СКАЗКИ / ЛОР =====
    "Эльфийская знать — лучи в тумане": {
    ...
    "Древняя Греция — мрамор и лазурь": {
    ...
    "Свадьба — лёгкий ветер и лепестки": {
    ...
    # ===== ИНФО/РОЛИ =====
    "Домашний уют — хозяйственные хлопоты": {
    ...
    "Медсестра (игриво и целомудренно)": {
...
THEME_BOOST = {
    "Пират капитан — шторм на палубе": "rope rigging, storm clouds, wet highlights on wood, sea spray, gulls",
    "Древняя Греция — мрамор и лазурь": "ionic capitals, olive trees, turquoise water reflections, gold trim accents",
    ...
    "Бал — люстры и паркет": "golden bokeh, polished parquet reflections",
    ...
    "Детство — шарики и флажки": "soft pastel garlands, shallow dof sparkles, gentle vignette",
    "Свадьба — лёгкий ветер и лепестки": "fairy lights bokeh, soft veil translucency",
    ...
    "Конная прогулка — лошади и поле": "mane motion highlights, dust sparkles in backlight",
    "Космический скафандр — EVA": "helmet micro-scratches, HUD reflections",
    "Киборг 50/50 — человек и металл": "subsurface skin vs brushed metal micro-contrast",
    "Вампирский бал — бархат и клыки": "candle halos, stained glass glows",
    "Золотые 50-е — ретро-динер": "checker floor reflections, chrome sparkle",
    "Кукла в коробке — витрина": "plastic gloss, cardboard print grain",
    "Зена-вайб — королева воинов": "wind-torn cloak edges, sun flare",
...
SCENE_GUIDANCE = {
    ...
    "Детство — шарики и флажки": 3.0,
    "Самурай в храме": 3.2,
    "Средневековый рыцарь": 3.2,
    "Космический скафандр — EVA": 3.2,
    "Киборг 50/50 — человек и металл": 3.2,
    "Вампирский бал — бархат и клыки": 3.2,
    "Зомби-апокалипсис (кино)": 3.2,
    "Монашка — мистический образ": 3.0,
    "Клоун — цирковой сюр": 3.0,
    "Кукла в коробке — витрина": 3.0,
    "Готэм-ночь (Бэтмен-вайб)": 3.2,
    "Халк-эффект (зелёная мощь)": 3.2,
    "Женщина-Кошка — ночной хищник": 3.2,
    "Харли-квинн — хаос и конфетти": 3.2,
    "Магическая школа (HP-вселенная)": 3.2,
    "Шир — хоббитская идиллия": 3.0,
    "Всадница дракона — в небесах": 3.0,
    "Дикий Запад — шериф и ковбои": 3.2,
    "Конная прогулка — лошади и поле": 3.0,
    "Пухлый герой — body-стилизация": 2.8
}
...
STYLE_CATEGORIES: Dict[str, List[str]] = {
    ...
    "Фэнтези и Сказки": [
        "Эльфийская знать — лучи в тумане", "Самурай в храме",
        "Средневековый рыцарь", "Пират капитан — шторм на палубе",
        "Древняя Греция — мрамор и лазурь", "Всадница дракона — в небесах",
        "Магическая школа (HP-вселенная)", "Шир — хоббитская идиллия",
        "Красная Шапочка в лесу", "Белоснежка и яблоко",
        "Спящая красавица — розы и сон"
    ],
    ...
    "Sci-Fi": [
        ...
        "Киборг 50/50 — человек и металл", "Контакт НЛО — лучи и пыль"
    ],
    "Ночные / Готика / Ужасы": [
        "Вампирский бал — бархат и клыки", "Зомби-апокалипсис (кино)",
        "Ведьма — чары и луна", "Монашка — мистический образ",
        "Клоун — цирковой сюр"
    ],
    "Ретро и Сцены жизни": [
        "Золотые 50-е — ретро-динер", "Бал — люстры и паркет",
        "Романтик 🥰 (деликатное бельё)", "Свадьба — лёгкий ветер и лепестки",
        "Детство — шарики и флажки", "Красотка — красное платье"
    ],
    "Транспорт и Драйв": [
        "Суперкары — хром и скорость", "Мото-культура — байк и дым"
    ],
    "Костюмные и Ролевые": [
        "Кукла в коробке — витрина", "Зена-вайб — королева воинов",
        "Домашний уют — хозяйственные хлопоты", "Учитель — класс и формулы",
        "Медсестра (игриво и целомудренно)", "Программист — неон и мониторы"
    ],
    "Трансформации": [
